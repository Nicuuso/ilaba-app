...
class AuthServiceImpl implements AuthService {
  ...
  Future<models.User> signup({
    ...
    try {
      ...
      debugPrint('❌ AuthException during signup: ${e.statusCode} - ${e.message}');
      
      if (e.statusCode == '400' && (e.message.contains('already registered') || e.message.contains('already exists'))) {
        throw Exception('Email address already registered. Please login or use a different email');
      } else if (e.statusCode == '422') {
